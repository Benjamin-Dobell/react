...
function toTree(node) {
  ...
  switch (node.tag) {
    ...
    default:
      !false ? process.env.NODE_ENV !== 'production' ? invariant(false, 'toTree() does not yet know how to handle nodes with tag=%s', node.tag) : _prodInvariant('194', node.tag) : void 0;
  }
}
...
var ReactTestFiberRenderer = {
  create: function (element, options) {
    ...
    !(root != null) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'something went wrong') : _prodInvariant('195') : void 0;
