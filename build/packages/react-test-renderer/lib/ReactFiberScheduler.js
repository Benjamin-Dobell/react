...
module.exports = function (config) {
  ...
  function commitAllWork(finishedWork) {
    ...
    !(root.current !== finishedWork) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'Cannot commit the same tree as before. This is probably a bug related to the return field. This error is likely caused by a bug in React. Please file an issue.') : _prodInvariant('180') : void 0;
    ...
    while (nextEffect !== null) {
      try {
        ...
        !(nextEffect !== null) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'Should have next effect. This error is likely caused by a bug in React. Please file an issue.') : _prodInvariant('181') : void 0;
  ...
  function performWork(priorityLevel, deadline) {
    !!isPerformingWork ? process.env.NODE_ENV !== 'production' ? invariant(false, 'performWork was called recursively. This error is likely caused by a bug in React. Please file an issue.') : _prodInvariant('182') : void 0;
    ...
    while (priorityLevel !== NoWork && !fatalError) {
      !(deadline !== null || priorityLevel < HighPriority) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'Cannot perform deferred work without a deadline. This error is likely caused by a bug in React. Please file an issue.') : _prodInvariant('183') : void 0;
  ...
  function commitErrorHandling(effectfulFiber) {
    ...
    !(capturedError != null) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'No error for given unit of work. This error is likely caused by a bug in React. Please file an issue.') : _prodInvariant('184') : void 0;
    ...
    switch (effectfulFiber.tag) {
      ...
      case HostRoot:
        ...
        return;
      default:
        !false ? process.env.NODE_ENV !== 'production' ? invariant(false, 'Invalid type of work. This error is likely caused by a bug in React. Please file an issue.') : _prodInvariant('162') : void 0;
    }
  }
