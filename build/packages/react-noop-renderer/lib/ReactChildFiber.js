...
function coerceRef(current, element) {
  ...
  if (mixedRef !== null && typeof mixedRef !== 'function') {
    if (element._owner) {
      ...
      !inst ? process.env.NODE_ENV !== 'production' ? invariant(false, 'Missing owner for string ref %s. This error is likely caused by a bug in React. Please file an issue.', mixedRef) : _prodInvariant('155', mixedRef) : void 0;
...
function ChildReconciler(shouldClone, shouldTrackSideEffects) {
  ...
  function reconcileChildrenIterator(returnFiber, currentFirstChild, newChildrenIterable, priority) {
    ...
    !(typeof iteratorFn === 'function') ? process.env.NODE_ENV !== 'production' ? invariant(false, 'An object is not an iterable. This error is likely caused by a bug in React. Please file an issue.') : _prodInvariant('156') : void 0;
    ...
    !(newChildren != null) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'An iterable object provided no iterator.') : _prodInvariant('157') : void 0;
        ...
        case FunctionalComponent:
          {
            ...
            !false ? process.env.NODE_ENV !== 'production' ? invariant(false, '%s(...): Nothing was returned from render. This usually means a return statement is missing. Or, to render nothing, return null.', _Component2.displayName || _Component2.name || 'Component') : _prodInvariant('158', _Component2.displayName || _Component2.name || 'Component') : void 0;
          }
      }
    }
