...
module.exports = function (config, hostContext, scheduleUpdate, getPriorityContext) {
  ...
  function updateHostComponent(current, workInProgress) {
    ...
    if (hasContextChanged()) {
      ...
      if (nextProps === null) {
        nextProps = memoizedProps;
        !(nextProps !== null) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'We should always have pending or current props. This error is likely caused by a bug in React. Please file an issue.') : _prodInvariant('159') : void 0;
      }
  ...
  function mountIndeterminateComponent(current, workInProgress, priorityLevel) {
    !(current === null) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'An indeterminate component should never have mounted. This error is likely caused by a bug in React. Please file an issue.') : _prodInvariant('160') : void 0;
    var fn = workInProgress.type;
  ...
  function updateCoroutineComponent(current, workInProgress) {
    ...
    if (hasContextChanged()) {
      ...
      if (nextCoroutine === null) {
        ...
        !(nextCoroutine !== null) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'We should always have pending or current props. This error is likely caused by a bug in React. Please file an issue.') : _prodInvariant('159') : void 0;
      }
  ...
  function updatePortalComponent(current, workInProgress) {
    ...
    if (hasContextChanged()) {
      ...
      if (nextChildren === null) {
        ...
        !(nextChildren != null) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'We should always have pending or current props. This error is likely caused by a bug in React. Please file an issue.') : _prodInvariant('159') : void 0;
      }
    } else if (nextChildren === null || workInProgress.memoizedProps === nextChildren) {
      return bailoutOnAlreadyFinishedWork(current, workInProgress);
    }
  ...
  */
  ...
  function beginWork(current, workInProgress, priorityLevel) {
    ...
    switch (workInProgress.tag) {
      ...
      default:
        !false ? process.env.NODE_ENV !== 'production' ? invariant(false, 'Unknown unit of work tag. This error is likely caused by a bug in React. Please file an issue.') : _prodInvariant('161') : void 0;
    }
  }

  function beginFailedWork(current, workInProgress, priorityLevel) {
    !(workInProgress.tag === ClassComponent || workInProgress.tag === HostRoot) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'Invalid type of work. This error is likely caused by a bug in React. Please file an issue.') : _prodInvariant('162') : void 0;
