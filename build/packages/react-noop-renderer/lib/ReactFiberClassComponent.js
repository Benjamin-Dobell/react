...
module.exports = function (scheduleUpdate, getPriorityContext, memoizeProps, memoizeState) {
  ...
  function mountClassInstance(workInProgress, priorityLevel) {
    ...
    var props = workInProgress.pendingProps;
    !props ? process.env.NODE_ENV !== 'production' ? invariant(false, 'There must be pending props for an initial mount. This error is likely caused by a bug in React. Please file an issue.') : _prodInvariant('163') : void 0;
  ...
  function resumeMountClassInstance(workInProgress, priorityLevel) {
    ...
    if (!newProps) {
      ...
      !(newProps != null) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'There should always be pending or memoized props. This error is likely caused by a bug in React. Please file an issue.') : _prodInvariant('164') : void 0;
    }
