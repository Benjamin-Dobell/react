...
module.exports = function (config, captureError) {
  ...
  function getHostParent(fiber) {
    ...
    !false ? process.env.NODE_ENV !== 'production' ? invariant(false, 'Expected to find a host parent. This error is likely caused by a bug in React. Please file an issue.') : _prodInvariant('165') : void 0;
  }
  ...
  function commitPlacement(finishedWork) {
    ...
    switch (parentFiber.tag) {
      ...
      case HostPortal:
        ...
        break;
      default:
        !false ? process.env.NODE_ENV !== 'production' ? invariant(false, 'Invalid host parent fiber. This error is likely caused by a bug in React. Please file an issue.') : _prodInvariant('166') : void 0;
    }
  ...
  function commitWork(current, finishedWork) {
    switch (finishedWork.tag) {
      ...
      case HostText:
        {
          !(finishedWork.stateNode !== null && current !== null) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'This should only be done during updates. This error is likely caused by a bug in React. Please file an issue.') : _prodInvariant('167') : void 0;
      ...
      default:
        {
          !false ? process.env.NODE_ENV !== 'production' ? invariant(false, 'This unit of work tag should not have side-effects. This error is likely caused by a bug in React. Please file an issue.') : _prodInvariant('168') : void 0;
        }
    }
  }
