...
exports.pushTopLevelContextObject = function (fiber, context, didChange) {
  !(contextStackCursor.cursor == null) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'Unexpected context found on stack') : _prodInvariant('173') : void 0;
...
exports.invalidateContextProvider = function (workInProgress) {
  var instance = workInProgress.stateNode;
  !instance ? process.env.NODE_ENV !== 'production' ? invariant(false, 'Expected to have an instance by this point.') : _prodInvariant('174') : void 0;
...
exports.findCurrentUnmaskedContext = function (fiber) {
  ...
  !(isFiberMounted(fiber) && fiber.tag === ClassComponent) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'Expected subtree parent to be a mounted class component') : _prodInvariant('175') : void 0;
  ...
  while (node.tag !== HostRoot) {
    ...
    !parent ? process.env.NODE_ENV !== 'production' ? invariant(false, 'Found unexpected detached subtree parent') : _prodInvariant('176') : void 0;
    node = parent;
  }
