...
module.exports = function (config, hostContext) {
  ...
  function appendAllYields(yields, workInProgress) {
    ...
    while (node !== null) {
      if (node.tag === HostComponent || node.tag === HostText || node.tag === HostPortal) {
        !false ? process.env.NODE_ENV !== 'production' ? invariant(false, 'A coroutine cannot have host component children.') : _prodInvariant('169') : void 0;
  ...
  function moveCoroutineToHandlerPhase(current, workInProgress) {
    ...
    !coroutine ? process.env.NODE_ENV !== 'production' ? invariant(false, 'Should be resolved by now. This error is likely caused by a bug in React. Please file an issue.') : _prodInvariant('170') : void 0;
  ...
  function completeWork(current, workInProgress) {
    ...
    switch (workInProgress.tag) {
      ...
      case HostComponent:
        {
          ...
          if (current !== null && workInProgress.stateNode != null) {
            ...
            if (!newProps) {
              !(workInProgress.stateNode !== null) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'We must have new props for new mounts. This error is likely caused by a bug in React. Please file an issue.') : _prodInvariant('171') : void 0;
      ...
      case IndeterminateComponent:
        !false ? process.env.NODE_ENV !== 'production' ? invariant(false, 'An indeterminate component should have become determinate before completing. This error is likely caused by a bug in React. Please file an issue.') : _prodInvariant('172') : void 0;
